library(here)
setwd(here())
ddir <- 'atlasGBM/subMouseGBM/integrate/harmony/rmCt_onlyGradeIV/result/'
pdir <- 'atlasGBM/subMouseGBM/integrate/harmony/rmCt_onlyGradeIV/plot/'
...
atlas <- readRDS('atlasGBM/mouseatlas/integrate/harmony/seuratGene/diff/celltype_annotation.rds')
anno <- c(atlas, gbm)
