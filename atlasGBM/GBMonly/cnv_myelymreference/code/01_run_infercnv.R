...
print(p)
anno <- read.table(paste0('atlasGBM/GBMonly/cnv_myelymreference/data/data/36nonNormal_myelym_combined_', p, '_cellanno.txt'), sep = '\t', as.is = TRUE)
dir.create(paste0('atlasGBM/GBMonly/cnv_myelymreference/',p,'/cutoff', cut, '/output'), recursive = TRUE, showWarnings = FALSE)
...
infercnv_obj = infercnv::run(infercnv_obj,
                             ...
                             out_dir=paste0('atlasGBM/GBMonly/cnv_myelymreference/',p,'/cutoff', cut, '/output'), 
