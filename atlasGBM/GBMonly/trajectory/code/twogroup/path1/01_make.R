ord <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/GBMonly/nmf/res/pt_path1.rds')
pt <- 1:length(ord)
names(pt) <- ord
expr <- readRDS('/home-4/whou10@jhu.edu/work-zfs/whou10/GBM/data/imp/saver/combine/log2norm_matrix.rds')
...
pt <- pt[selectcell]
res <- testpt(expr,test.type='VARIABLE', cellanno=cellanno, pseudotime=pt, design = design,ncores=5)

saveRDS(res,paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/GBMonly/trajectory/res/path1/twogroup/',loc[1],'_',loc[2],'.rds'))
