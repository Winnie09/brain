...
saveRDS(gl,file=here('atlasGBM','humanatlas','diffgene','res', 'celltype_diffgene_pairwise_difference_includeBothAllen.rds'))
...
gl <- unique(unlist(gl))
saveRDS(gl,file=here('atlasGBM','humanatlas','diffgene','res', 'celltype_diffgene_pairwise_limma_includeBothAllen.rds'))
