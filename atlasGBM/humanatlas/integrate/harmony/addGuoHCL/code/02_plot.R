...
pdir <- './humanatlas/integrate/harmony/allen10xSeuratGene2000/plot/'  ####
u <- readRDS('./humanatlas/integrate/harmony/allen10xSeuratGene2000/res/umap_embeddings.rds') ########
meta <- readRDS('./humanatlas/data/meta_allcell.rds')
mat <- readRDS('./humanatlas/data/combine_mat.rds')
...
for (i in seq(1,ncol(tb))[21:ncol(tb)]){
  print(i)
  plist = list()
...
## plot cluster facet
brain <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanatlas/integrate/harmony/allen10xSeuratGene2000/res/humanAtlas_harmony.rds')
clu <- brain@active.ident
saveRDS(clu, file='/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanatlas/integrate/harmony/allen10xSeuratGene2000/res/active.ident.rds')

clu = readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanatlas/integrate/harmony/allen10xSeuratGene2000/res/active.ident.rds')
