...
saveRDS(dlist, '/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanatlas/data/dlist_add_2020_Guo_Nature.rds')

mat = do.call(cbind, dlist)
saveRDS(mat, '/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanatlas/data/combine_mat_add_2020_Guo_Nature.rds')
