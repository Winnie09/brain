...
here()
setwd(here())
rdir <- ddir <- 'atlasGBM/subHumanGBM/integrate/harmony/rmCt_onlyGradeIV/result/'
pdir <- 'atlasGBM/subHumanGBM/integrate/harmony/rmCt_onlyGradeIV/plot/diffusion_from_pca/'
