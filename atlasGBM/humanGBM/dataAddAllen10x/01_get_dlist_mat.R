...
rdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanGBM/dataAddAllen10x/'
...
saveRDS(dlist, paste0(rdir, 'dlist.rds'))

mat = do.call(cbind, dlist)
saveRDS(mat, paste0(rdir, 'combine_mat.rds'))
