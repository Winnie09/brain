...
here()
setwd(here())
rdir <- ddir <- 'atlasGBM/humanGBM/integrate/harmony/36nonNormal_allen10xOnly_seuratGene/res/'
pdir <- 'atlasGBM/humanGBM/integrate/harmony/36nonNormal_allen10xOnly_seuratGene/plot/diffusion_from_pca/'
