...
rdir = './atlasGBM/humanGBM/integrate/harmony/rmTumornormaldiff/res/'  ##### 
dir.create(rdir, recursive = TRUE, showWarnings = FALSE)
mat =  readRDS('./atlasGBM/humanGBM/data/combine_mat.rds')
meta =  readRDS('./atlasGBM/humanGBM/data/meta_allcell.rds')
rownames(meta) <- meta$cell

diffgene <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/humanGBM/diffgene/res/tumornormal_diffgene_limma.rds')  #####
selectcell <- meta$cell[!grepl('2014_Pollen_NatBiotech', meta$study)]  #####
mat <- mat[,selectcell]
...
integrated.features <- setdiff(integrated.features, diffgene)
...
saveRDS(brain,paste0(rdir, 'humanAtlas_GBM_harmony_tmp.rds'))
