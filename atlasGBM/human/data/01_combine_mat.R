...
## 4
dlist[['allen']] <- countfunc(readRDS('./allen/data/proc/count.rds'), species='human')
## 5
...
saveRDS(mat, '/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlasGBM/human/data/combine_mat.rds')
