...
for (i in names(dlist)) {
  if (ncol(dlist[[i]]) > 30000) dlist[[i]] <- dlist[[i]][,sample(1:ncol(dlist[[i]]),30000)]
}
...
saveRDS(d.integrated,'/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlas/res/integrated_GBM_reference_sub.rds')
