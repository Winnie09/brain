...
d.integrated <- RunUMAP(d.integrated, reduction = "pca", dims = 1:5)
u = d.integrated@reductions$umap@cell.embeddings
dir.create(paste0('./brain/atlas/seurat/result/',data,'/umap_5PC/'),showWarnings = F,recursive = T)
saveRDS(u,paste0('./brain/atlas/seurat/result/',data,'/umap_5PC/umap.rds'))
