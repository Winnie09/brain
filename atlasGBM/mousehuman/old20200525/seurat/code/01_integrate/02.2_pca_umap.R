...
d.integrated <- RunUMAP(d.integrated, reduction = "pca", dims = 1:10)
u = d.integrated@reductions$umap@cell.embeddings
dir.create(paste0('./brain/atlas/seurat/result/',data,'/umap_10PC/'),showWarnings = F,recursive = T)
saveRDS(u,paste0('./brain/atlas/seurat/result/',data,'/umap_10PC/umap.rds'))
