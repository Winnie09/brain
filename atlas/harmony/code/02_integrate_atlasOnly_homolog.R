...
dir.create('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlas/harmony/result/atlasOnly_homolog/',showWarnings = F, recursive = T)
saveRDS(brain,'/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlas/harmony/result/atlasOnly_homolog/integrated.rds')

brain <- RunHarmony(brain, "dataset")

pca_embeddings <- Embeddings(brain, 'pca')
saveRDS(pca_embeddings,'/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlas/harmony/result/atlasOnly_homolog/pca_embeddings.rds')

harmony_embeddings <- Embeddings(brain, 'harmony')
saveRDS(harmony_embeddings,'/home-4/whou10@jhu.edu/scratch/Wenpin/brain/atlas/harmony/result/atlasOnly_homolog/harmony_embeddings.rds')
