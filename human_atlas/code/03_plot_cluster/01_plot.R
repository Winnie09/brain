...
library(ggplot2)
library(gridExtra)
dir.create(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/human_atlas/plot/',key,'/umap_cluster'),showWarnings = F,recursive = T)
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/brain/human_atlas/plot/',key,'/umap_cluster/',sp,'.pdf'),width=18,height=12)
