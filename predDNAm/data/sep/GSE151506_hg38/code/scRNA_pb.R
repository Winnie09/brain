...
m <- t(m)
tab <- table(s)
m2 <- m[,names(tab)[tab >= 5]]
saveRDS(m2,file='/home/whou10/scratch16/whou10/brain/predDNAm/data/sep/GSE151506_hg38/proc/scRNA/saver_log2tpm_pb_atLeast5Cell.rds')
