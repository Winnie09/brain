...
m <- readRDS('./atlas/old/20200212/result/full/meta.rds')
...
saveRDS(list(pd1,ap),'./pseudotime/plot/plot/pseudotime_umap_pd.rds')
pdf('./pseudotime/plot/plot/pseudotime.pdf',width=10,height=10)
ggplot() + geom_point(data=pd1,aes(x=x,y=y,col=ct),alpha=0.5,size=0.2) + 
